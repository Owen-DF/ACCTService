...
# BLANK_CELL = 'G101'
# OPENPOS = r'C:\Users\ofleischer\OneDrive - MetroTek Electrical\Coding\SampleFiles\Open POs.xlsx'  # need
# JOBHOURS = r'C:\Users\ofleischer\OneDrive - MetroTek Electrical\Coding\SampleFiles\Job Hours.xlsx'  # need
...
#     PreProcessExcelFiles(ExcelFilePaths, itemList, stepValue)


# def PreProcessExcelFiles(ExcelList, itemList, stepValue):
...
#         processExcel(file_path, searchTerm, df, stepValue)
    
#     print("All files processed")


# def processExcel(filePath, searchTerm, df, stepValue):
#     items = {
...
def pullExcel(matchingFolders, itemList):
    ExcelFilePaths = []
    stepValue = 100 / len(matchingFolders) if matchingFolders else 0
...
def PreProcessExcelFiles(ExcelList, itemList, stepValue):
    ...
    for i, file_path in enumerate(ExcelList):
        searchTerm = itemList[i]
        processExcel(file_path, searchTerm, df, df_open_pos, df_job_hours, stepValue)
    
    print("All files processed")

def processExcel(filePath, searchTerm, df, df_open_pos, df_job_hours, stepValue):
    items = {
        '01.01': 'G9', '01.02': 'G10', '02.01': 'G21', '02.02': 'G22', '02.03': 'G23',
        '03.01': 'G37', '03.02': 'G38', '03.03': 'G39', '04.01': 'G48', '04.02': 'G49',
        '04.03': 'G50', '04.04': 'G51', '05.01': 'G63', '05.02': 'G64', '05.03': 'G65',
